defmodule WithoutCeasing.Accounts.Member do
  use Ecto.Schema
  ...
  schema "members" do
    ...
    has_many :account_members, WithoutCeasing.AccountMember, on_delete: :delete_all
  ...
  """
  def valid_password?(%WithoutCeasing.Accounts.Member{hashed_password: hashed_password}, password)
